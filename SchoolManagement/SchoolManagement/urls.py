...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="shanmukh.adari.ext@nokia.com"),
...
urlpatterns += [ 
    ...
    path('swagger/SCHOOLMANAGEMENT/', schema_view.with_ui('swagger', cache_timeout=0), name='schema-swagger-ui'),
